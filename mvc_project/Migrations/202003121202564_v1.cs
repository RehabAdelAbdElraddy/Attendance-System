    ...
    public partial class v1 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        PermId = c.Int(nullable: false, identity: true),
                        StdId = c.String(maxLength: 128),
                        PermDate = c.String(),
                        Note = c.String(),
                        Status = c.String(),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Permissions", "StdId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Attendances", "StdId", "dbo.AspNetUsers");
